...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    {
      link: true,
      name: "Destek Sunucumuz",
      icon: "fab fa-discord",
      activeIcon: "fab fa-discord",
      href: "https://discord.gg/kJjVYb95aq",
    },
    {
      link: true,
      name: "Botu Ekle",
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=993587710356893816&permissions=8&scope=applications.commands%20bot",
    },
       {
      link: true,
      name: "Oy Ver",
      ...
      href: "https://top.gg/bot/993587710356893816/vote",
    },
    {
      link: true,
      name: "Ortaklar",
