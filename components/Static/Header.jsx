            ...
            <div className="relative w-full h-full">
                ...
                <div className="flex justify-between border-b border-white/20 items-center px-5 py-4">
                    <div className="flex items-center">
                        <img width="32" className="rounded-full icon-glow" src="https://images-ext-2.discordapp.net/external/Vw5oASgohJBUOihvw1GVfvXaA0fnDVPqfEyAcqeNW3s/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/993587710356893816/e5a3760d2944097859d2adaf8922289b.webp?width=625&height=625" />
                        <p className=" font-extrabold ml-1 text-2xl">Trefax Bot</p>
                    </div>
            ...
            <header>
                <div className="max-w-7xl px-5 mx-auto py-5 flex items-center justify-between">
                    <div className="flex items-center space-x-6">
                        <div className="flex items-center space-x-3">
                            ...
                            <p className="invisible md:visible text-xl text-white font-semibold">
                              <a href="/"><span className="text-amber-400">Trefax</span>Bot</a>
                            </p>
                        </div>
                    ...
                    <div className="flex items-center space-x-2 relative">
                        ...
                        <Link href="https://discord.com/api/oauth2/authorize?client_id=993587710356893816&permissions=8&scope=applications.commands%20bot">
